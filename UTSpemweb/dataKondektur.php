        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <?php 
            ...
            if (@$_GET['status']!==NULL) {
              $status = $_GET['status'];
              if ($status=='ok') {
                echo '<br><br><div class="alert alert-success" role="alert">Data Kodektur berhasil di-update</div>';
              }
              elseif($status=='err'){
                echo '<br><br><div class="alert alert-danger" role="alert">Data Kodektur gagal di-update</div>';
              }
            }
           ?>
                 ...
                 <?php while($data = mysqli_fetch_array($result)): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      &nbsp;&nbsp;
                      <a href="<?php echo "delKondektur.php?id_kondektur=".$data['id_kondektur']; ?>" class="btn btn-outline-danger btn-sm"> Delete</a>
                    </td>
                  </tr>
                 <?php endwhile ?>
              </tbody>
